...
urlpatterns = [
    ...
    path('ajax/toggle-status/<int:pk>/', views.toggle_usuario_status, name='toggle_usuario_status'),
    path('ajax/bulk-action/', views.bulk_action_usuarios, name='bulk_action_usuarios'),
